    ...
    function tt_theme_register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                ...
                'source'             => 'http://104.131.177.38/demo2/plsrc/nominee/tt-plugin.zip',
                // The plugin source
                'required'           => TRUE,
            ...
            array(
                ...
                'slug'     => 'js_composer',
                // The plugin slug (typically the folder name)
                'source'   => 'http://104.131.177.38/demo2/plsrc/vc/js_composer.zip',
                // The plugin source
                'required' => TRUE,
                // If false, the plugin is only 'recommended' instead of required
            ),
            ...
            array(
                ...
                'slug'     => 'revslider',
                // The plugin slug (typically the folder name)
                'source'   => 'http://104.131.177.38/demo2/plsrc/rs/revslider.zip',
                // The plugin source
                'required' => TRUE,
                // If false, the plugin is only 'recommended' instead of required
            ),
